...
use crate::provider::funds_activity_provider::{
    FundsActivityProvider, FundsActivityViewData, LoadFundsActivityParJs, LoadFundsActivityResJs,
};
use anyhow::Result;
    ...
    async fn get(&self, _: LoadFundsActivityParJs) -> Result<LoadFundsActivityResJs> {
        ...
        Ok(LoadFundsActivityResJs {
            entries: vec![FundsActivityViewData {
                ...
                date: "Wed, 20 Apr 2022 12:01:00 +0000".to_owned(),
                tx_id: mock_tx_id(),
