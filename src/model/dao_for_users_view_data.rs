...
pub fn dao_for_users_to_view_data(
    ...
    DaoForUsersViewData {
        ...
        central_app_id: dao.central_app_id.to_string(),
        customer_escrow_address: dao.customer_escrow_address.to_string(),
        investing_escrow_address: dao.invest_escrow_address.to_string(),
        locking_escrow_address: dao.locking_escrow_address.to_string(),
