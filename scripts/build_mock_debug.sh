...
#
NETWORK=test ENV=test DATA_TYPE=mock FUNDS_ASSET_ID=123 CAPI_ADDRESS=NIKGABIQLRCPJYCNCFZWR7GUIC3NA66EBVR65JKHKLGLIYQ4KO3YYPV67Q wasm-pack build --out-dir ../wasm-build --debug
